        ...
        <form class="layui-form" id="searchForm">
            <div class="layui-inline" style="margin-left: 15px">
                ...
                <div class="layui-input-inline">
                    <input type="text" value="" name="name" placeholder="请输入订单名称" class="layui-input search_input">
                </div>
            </div>
            <div class="layui-inline" style="margin-left: 15px">
                <label>课程等级:</label>
                <div class="layui-input-inline">
                    <select name="level">
                        ...
                        <option value="0" >普通本科</option>
                        <option value="1" >普通专科</option>
                    </select>
                </div>
            </div>
            <div class="layui-inline" style="margin-left: 15px">
...
<div class="layui-form orders_list">
...
<script>
    layui.use(['layer','form','table','laydate'], function() {
        ...
        var t = {
            ...
            cols: [[
                {type:'checkbox'},
                {field:'name', title: '任务名称',templet:'#content'},
                {field:'categories', title: '类别'},
