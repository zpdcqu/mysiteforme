...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input  type="text"  class="layui-input" name="num"  placeholder="请输入金额">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <div class="layui-upload">
                ...
                <div class="layui-upload-list">
                    <img class="layui-upload-img" id="demo_url">
                    <p id="demoText_url"></p>
                </div>
            </div>
        </div>
...
<script>
    layui.use(['form','jquery','layer','upload'],function(){
        ...
        form.on("submit(addMoneyLog)",function(data){
            ...
            $.post("${base}/admin/moneyLog/add",data.field,function(res){
                layer.close(loadIndex);
                if(res.success){
                    parent.layer.msg("付款记录添加成功！",{time:1000},function(){
