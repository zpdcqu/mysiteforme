						...
						<div class="layui-form-item">
							<div class="layui-inline">
								...
								<div class="layui-input-block">
									<input type="text" class="layui-input" name="orderId" value="${orderId}" disabled placeholder="请输入订单编号">
								</div>
							</div>
							<div class="layui-inline">
					...
					<div class="layui-colla-item">
						...
						<div class="layui-colla-content layui-show">
							<div class="layui-inline">
								...
								<div class="layui-input-block">
									<input type="text" class="layui-input" disabled name="loginName" value="${loginName}" placeholder="请输入关联客户">
								</div>
							</div>
							<div class="layui-inline">
					...
					<div class="layui-colla-item">
					  ...
					  <table>
								...
								<tr>
									...
									<#list demandList as demand>
										<#if (demand.type==r.value)>
											<#if (demand.option)>
												<div class="layui-inline ">
													<input type="checkbox" name="${demand.id}" class="me"   title="${demand.name}：">
												</div>
												<div class="layui-inline ">
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<textarea name="remarks" placeholder="请输入其他需求" class="layui-textarea">${orderList.others}</textarea>
								</div>
							</div>
				  ...
				  ,uploadListIns = upload.render({
				    ...
				    ,done: function(res, index, upload){
				      ...
				      if(res.success == true){ //上传成功
				        ...
				        tds.eq(3).html('<a href='+'${base}/file/download?hash='+res.data.hash+'>下载</a>'); //清空操作
